...
f2 = Flight.create :origin => 'SYD', :destination => 'MEL', :date => '2016/01/03', :plane_id => 1
f3 = Flight.create :origin => 'SYD', :destination => 'MEL', :date => '2016/01/03', :plane_id => 1
f4 = Flight.create :origin => 'SYD', :destination => 'MEL', :date => '2016/01/03', :plane_id => 1
